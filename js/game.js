...
nextstage.preload = function() {
    Kiwi.State.prototype.preload.call(this);

    this.addImage( 'background-next', 'assets/bg.png' );
}

nextstage.create = function() {
    Kiwi.State.prototype.create.call( this );
...
nextstage.update = function(){
    Kiwi.State.prototype.update.call(this);
}

nextstage.buttonPressed = function() {
